...
// console.log(toRead)
    ...
    let bookList = books.filter(book => bookId.includes(book.id) )
            ...
            <div className="text-center">
                ...
                <div className={show ? "visible" : "invisible"}>
                    <ul className="text-lg bg-[#F3F3F3] w-fit m-auto px-4 py-1 rounded-b-lg">
                        <li onClick={() => setShow(!show)} className="hover:bg-white px-8 py-1 rounded-lg cursor-pointer ">Rating</li>
                        <li onClick={() => setShow(!show)} className="hover:bg-white px-8 py-1 rounded-lg cursor-pointer ">Number of pages</li>
                        <li onClick={() => setShow(!show)} className="hover:bg-white px-8 py-1 rounded-lg cursor-pointer ">Publisher year</li>
                    </ul>
                </div>
