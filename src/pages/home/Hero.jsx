    ...
    return (
        <div className="my-4 md:my-10">
            <div className="bg-[#F3F3F3] rounded-3xl mx-auto flex flex-col-reverse lg:flex-row items-center content-center border p-5">
                <div className="text-center lg:text-start lg:w-2/3 lg:pl-20">
                    <h3 className="font-bold text-xl md:text-3xl lg:text-6xl text-black text-balance">Books to freshen up your bookshelf</h3>
                ...
                <div className="lg:w-1/3 "><img src="/pngwing1.png" alt="book" /></div>
